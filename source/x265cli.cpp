...
#define H1 if (level >= X265_LOG_DEBUG) printf
        ...
        H1("-q/--qp <integer>                QP for P slices in CQP mode (implied). --ipratio, --pbratio and --bbratio determine other slice QPs, --brbratio for ref-b and non-ref-b slice QP\n");
        ...
        H0("   --[b]rbratio <float>          QP factor between reference B and non-reference B in same sublayers. Default %.2f\n", param->rc.rbFactor);

...
static const x265_temporal_layer x265_gop_ra[X265_MAX_GOP_CONFIG][X265_MAX_GOP_LENGTH] = {
    { { 2, 0, 0}, { 1, 1, 2} }, //2
    { { 3, 0, 0}, { 2, 1, 1}, { 1, 2, 2} }, //3
    { { 4, 0, 0}, { 2, 1, 1}, { 1, 2, 2}, { 3, 2, 2} }, //4
    { { 5, 0, 0}, { 4, 1, 0}, { 2, 2, 1}, { 1, 3, 2}, { 3, 3, 2} }, //5
    { { 6, 0, 0}, { 4, 1, 0}, { 2, 2, 1}, { 1, 3, 2}, { 3, 3, 2}, { 5, 2, 2} }, //6
    { { 7, 0, 0}, { 4, 1, 0}, { 2, 2, 1}, { 1, 3, 2}, { 3, 3, 2}, { 6, 2, 1}, { 5, 3, 2} }, //7
    { { 8, 0, 0}, { 4, 1, 0}, { 2, 2, 1}, { 1, 3, 2}, { 3, 3, 2}, { 6, 2, 1}, { 5, 3, 2}, { 7, 3, 2} }, //8
    { { 9, 0, 0}, { 8, 1, 0}, { 4, 2, 0}, { 2, 3, 1}, { 1, 4, 2}, { 3, 4, 2}, { 6, 3, 1}, { 5, 4, 2}, { 7, 4, 2} }, //9
    { {10, 0, 0}, { 8, 1, 0}, { 4, 2, 0}, { 2, 3, 1}, { 1, 4, 2}, { 3, 4, 2}, { 6, 3, 1}, { 5, 4, 2}, { 7, 4, 2}, { 9, 2, 2} }, //10
    { {11, 0, 0}, { 8, 1, 0}, { 4, 2, 0}, { 2, 3, 1}, { 1, 4, 2}, { 3, 4, 2}, { 6, 3, 1}, { 5, 4, 2}, { 7, 4, 2}, {10, 2, 1}, { 9, 3, 2} }, //11
    { {12, 0, 0}, { 8, 1, 0}, { 4, 2, 0}, { 2, 3, 1}, { 1, 4, 2}, { 3, 4, 2}, { 6, 3, 1}, { 5, 4, 2}, { 7, 4, 2}, {10, 2, 1}, { 9, 3, 2}, {11, 3, 2} }, //12
    { {13, 0, 0}, { 8, 1, 0}, { 4, 2, 0}, { 2, 3, 1}, { 1, 4, 2}, { 3, 4, 2}, { 6, 3, 1}, { 5, 4, 2}, { 7, 4, 2}, {12, 2, 0}, {10, 3, 1}, { 9, 4, 2}, {11, 4, 2}, }, //13
    { {14, 0, 0}, { 8, 1, 0}, { 4, 2, 0}, { 2, 3, 1}, { 1, 4, 2}, { 3, 4, 2}, { 6, 3, 1}, { 5, 4, 2}, { 7, 4, 2}, {12, 2, 0}, {10, 3, 1}, { 9, 4, 2}, {11, 4, 2}, {13, 3, 2} }, //14
    { {15, 0, 0}, { 8, 1, 0}, { 4, 2, 0}, { 2, 3, 1}, { 1, 4, 2}, { 3, 4, 2}, { 6, 3, 1}, { 5, 4, 2}, { 7, 4, 2}, {12, 2, 0}, {10, 3, 1}, { 9, 4, 2}, {11, 4, 2}, {14, 3, 1}, {13, 4, 2} }, //15
    { {16, 0, 0}, { 8, 1, 0}, { 4, 2, 0}, { 2, 3, 1}, { 1, 4, 2}, { 3, 4, 2}, { 6, 3, 1}, { 5, 4, 2}, { 7, 4, 2}, {12, 2, 0}, {10, 3, 1}, { 9, 4, 2}, {11, 4, 2}, {14, 3, 1}, {13, 4, 2}, {15, 4, 2} }, //16
};

static const x265_gop_cost x265_gop_cost_tbl[X265_MAX_GOP_CONFIG][X265_MAX_GOP_LENGTH-1] =
{
    { { 0,  2,  1 } },
    { { 0,  3,  2 }, { 0,  2,  1 } },
    { { 0,  4,  2 }, { 0,  2,  1 }, { 2,  4,  3 } },
    { { 0,  5,  4 }, { 0,  4,  2 }, { 0,  2,  1 }, { 2,  4,  3 } },
    { { 0,  6,  4 }, { 0,  4,  2 }, { 0,  2,  1 }, { 2,  4,  3 }, { 4,  6,  5 } },
    { { 0,  7,  4 }, { 0,  4,  2 }, { 0,  2,  1 }, { 2,  4,  3 }, { 4,  7,  6 }, { 4,  6,  5 } },
    { { 0,  8,  4 }, { 0,  4,  2 }, { 0,  2,  1 }, { 2,  4,  3 }, { 4,  8,  6 }, { 4,  6,  5 }, { 6,  8,  7 } },
    { { 0,  9,  8 }, { 0,  8,  4 }, { 0,  4,  2 }, { 0,  2,  1 }, { 2,  4,  3 }, { 4,  8,  6 }, { 4,  6,  5 }, { 6,  8,  7 } },
    { { 0, 10,  8 }, { 0,  8,  4 }, { 0,  4,  2 }, { 0,  2,  1 }, { 2,  4,  3 }, { 4,  8,  6 }, { 4,  6,  5 }, { 6,  8,  7 }, { 8, 10,  9 } },
    { { 0, 11,  8 }, { 0,  8,  4 }, { 0,  4,  2 }, { 0,  2,  1 }, { 2,  4,  3 }, { 4,  8,  6 }, { 4,  6,  5 }, { 6,  8,  7 }, { 8, 11, 10 }, { 8, 10,  9 } },
    { { 0, 12,  8 }, { 0,  8,  4 }, { 0,  4,  2 }, { 0,  2,  1 }, { 2,  4,  3 }, { 4,  8,  6 }, { 4,  6,  5 }, { 6,  8,  7 }, { 8, 12, 10 }, { 8, 10,  9 }, { 10, 12, 11 } },
    { { 0, 13,  8 }, { 0,  8,  4 }, { 0,  4,  2 }, { 0,  2,  1 }, { 2,  4,  3 }, { 4,  8,  6 }, { 4,  6,  5 }, { 6,  8,  7 }, { 8, 13, 12 }, { 8, 12, 10 }, {  8, 10,  9 }, { 10, 12, 11 } },
    { { 0, 14,  8 }, { 0,  8,  4 }, { 0,  4,  2 }, { 0,  2,  1 }, { 2,  4,  3 }, { 4,  8,  6 }, { 4,  6,  5 }, { 6,  8,  7 }, { 8, 14, 12 }, { 8, 12, 10 }, {  8, 10,  9 }, { 10, 12, 11 }, { 12, 14, 13 } },
    { { 0, 15,  8 }, { 0,  8,  4 }, { 0,  4,  2 }, { 0,  2,  1 }, { 2,  4,  3 }, { 4,  8,  6 }, { 4,  6,  5 }, { 6,  8,  7 }, { 8, 15, 12 }, { 8, 12, 10 }, {  8, 10,  9 }, { 10, 12, 11 }, { 12, 15, 14 }, { 12, 14, 13 } },
    { { 0, 16,  8 }, { 0,  8,  4 }, { 0,  4,  2 }, { 0,  2,  1 }, { 2,  4,  3 }, { 4,  8,  6 }, { 4,  6,  5 }, { 6,  8,  7 }, { 8, 16, 12 }, { 8, 12, 10 }, {  8, 10,  9 }, { 10, 12, 11 }, { 12, 16, 14 }, { 12, 14, 13 }, { 14, 16, 15 } },
};
...
static const x265_temporal_layer x265_gop_ra_fast[X265_FAST_GOP_CONFIG][X265_FAST_GOP_LENGTH] = {
    { { 2, 0, 0}, { 1, 2, 1} }, //2
    { { 3, 0, 0}, { 1, 2, 1}, { 2, 2, 1} }, //3
    { { 4, 0, 0}, { 2, 1, 0}, { 1, 2, 1}, { 3, 2, 1} }, //4
    { { 5, 0, 0}, { 2, 1, 0}, { 1, 2, 1}, { 3, 2, 1}, { 4, 2, 1} }, //5
    { { 6, 0, 0}, { 2, 1, 0}, { 1, 2, 1}, { 4, 1, 0}, { 3, 2, 1}, { 5, 2, 1} }, //6
    { { 7, 0, 0}, { 2, 1, 0}, { 1, 2, 1}, { 5, 1, 0}, { 3, 2, 1}, { 4, 2, 1}, { 6, 2, 1} }, //7
    { { 8, 0, 0}, { 3, 1, 0}, { 1, 2, 1}, { 2, 2, 1}, { 5, 1, 0}, { 4, 2, 1}, { 6, 2, 1}, { 7, 2, 1} }, //8
    { { 9, 0, 0}, { 3, 1, 0}, { 1, 2, 1}, { 2, 2, 1}, { 6, 1, 0}, { 4, 2, 1}, { 5, 2, 1}, { 7, 2, 1}, { 8, 2, 1} } //9
};

static const x265_gop_cost x265_gop_cost_fast_tbl[X265_FAST_GOP_CONFIG][X265_FAST_GOP_LENGTH-1] =
{
    { { 0,  2,  1 } },
    { { 0,  3,  1 }, { 0,  3,  2 } },
    { { 0,  4,  2 }, { 0,  2,  1 }, { 2,  4,  3 } },
    { { 0,  5,  2 }, { 0,  2,  1 }, { 2,  5,  3 }, { 2,  5,  4 } },
    { { 0,  6,  2 }, { 0,  2,  1 }, { 0,  6,  4 }, { 2,  4,  3 }, { 4,  6,  5 } },
    { { 0,  7,  2 }, { 0,  2,  1 }, { 0,  7,  5 }, { 2,  5,  3 }, { 2,  5,  4 }, { 5,  7,  6 } },
    { { 0,  8,  3 }, { 0,  3,  1 }, { 0,  3,  2 }, { 0,  8,  5 }, { 3,  5,  4 }, { 5,  8,  6 }, { 5,  8,  7 } },
    { { 0,  9,  3 }, { 0,  3,  1 }, { 0,  3,  2 }, { 0,  9,  6 }, { 3,  6,  4 }, { 3,  6,  5 }, { 6,  9,  7 }, { 6,  9,  8 } }
};
